...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "Error::The total number of blocks must be a multiple of the "
                     "number of ranks\n";
        return -1;
    }
    while (true)
    {
        ...
        for (int i = 0; i < n_vars; i++)
        {
            ...
            var_ad2 = reader_io.InquireVariable<double>("/hpMusic_base/hpMusic_Zone/FlowSolution/" +
                                                        var_name[i]);
